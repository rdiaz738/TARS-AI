...
def load_config():
    ...
    return {
        ...
        "STT": {
            ...
            "vad_enabled": config.getboolean('STT', 'vad_enabled', fallback=True),
            "vad_threshold": float(config['STT'].get('vad_threshold', '0.3')),
            "min_speech_duration_ms": int(config['STT'].get('min_speech_duration_ms', '100')),
            "min_silence_duration_ms": int(config['STT'].get('min_silence_duration_ms', '200')),
            "speech_pad_ms": int(config['STT'].get('speech_pad_ms', '30')),
            "max_silent_frames": int(config['STT'].get('max_silent_frames', '100')),
            "speech_buffer_size": int(config['STT'].get('speech_buffer_size', '20')),
            "silence_margin": float(config['STT'].get('silence_margin', '3.5')),
        },
        "CHAR": {
